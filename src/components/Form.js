import { Backdrop, Button, CircularProgress, FormControl, Grid, Snackbar, TextField } from '@material-ui/core';
...
function Table() {
  ...
  const formIsValid = () => {
    if (
      isObjectEmpty(city) || isObjectEmpty(district) ||
        isObjectEmpty(job) || isObjectEmpty(entity) ||
  ...
  return (
    <form noValidate autoComplete="off" onSubmit={handleSubmit} >
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} lg={3} >
          <Button variant="contained" color="primary" type="submit" className="health-insurance-form-button">
            Buscar Resultados
          </Button>
        </Grid>
      </Grid>
